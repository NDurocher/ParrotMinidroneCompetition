function arr = fcn(Redim)
if coder.target('MATLAB')
    clear;
    clc;
    close all;
    pic = imread("fail2.png");
    imshow(pic);
else
    pic=Redim;
end
...
elseif(size(concLines,2)==3)
        ...
        if(size(lineS1,1)==4)
            line1=lineS1;
            if(sqrt(lineS1(1,3)^2-lineS2(1,3)^2)<sqrt(lineS1(1,3)^2-lineS3(1,3)^2))
                line2 = [lineS2;lineS3];
            else
                line2 = [lineS3;lineS2];
            end
        elseif(size(lineS2,1)==4)
            line1 = lineS2;
            if(sqrt(lineS2(1,3)^2-lineS1(1,3)^2)<sqrt(lineS2(1,3)^2-lineS3(1,3)^2))
                line2 = [lineS1;lineS3];
            else
                line2 = [lineS3;lineS1];
            end
        elseif(size(lineS3,1)==4)
            line1 = lineS3;
            if(sqrt(lineS3(1,3)^2-lineS1(1,3)^2)<sqrt(lineS3(1,3)^2-lineS2(1,3)^2))
                line2 = [lineS1;lineS2];
            else
                line2 = [lineS2;lineS1];
            end
...
if(size(centerLine,1)>=2)
    arr = pointsToLine(centerLine(1,:), centerLine(2,:), arr);
end
if(size(centerLine,1)>=4)
    arr = pointsToLine(centerLine(3,:), centerLine(4,:), arr);
end
